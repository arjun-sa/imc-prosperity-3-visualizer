...
export function LoadFromUrl(): ReactNode {
  ...
  return (
    <HomeCard title="Load from URL">
      <Text>
        Supports both the classic Prosperity server log format and Prosperity 4 JSON artifacts. The URL must allow
        cross-origin requests from the visualizer&apos;s website.
      </Text>
      <Text>
